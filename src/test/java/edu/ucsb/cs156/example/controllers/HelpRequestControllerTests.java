...
public class HelpRequestControllerTests extends ControllerTestCase {
  ...
  public void an_admin_user_can_post_a_new_helprequest() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/HelpRequest/post?requesterEmail=student@ucsb.edu&teamId=team01&tableOrBreakoutRoom=Table 7&requestTime=2022-01-03T00:00:00&explanation=Need help with Git&solved=false")
                    .with(csrf()))
  ...
  @WithMockUser(roles = {"ADMIN", "USER"})
  @Test
  public void an_admin_user_can_post_a_new_helprequest_with_solved_true() throws Exception {
    // arrange
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/HelpRequest/post?requesterEmail=student@ucsb.edu&teamId=team01&tableOrBreakoutRoom=Table 7&requestTime=2022-01-03T00:00:00&explanation=Need help with Git&solved=true")
                    .with(csrf()))
            .andExpect(status().isOk())
            .andReturn();
  ...
  public void admin_can_edit_an_existing_helprequest() throws Exception {
    ...
    verify(helpRequestRepository, times(1))
        .save(helpRequestEdited); // should be saved with correct values
    String responseString = response.getResponse().getContentAsString();
